...
<html>
    <body>
        <form action="recibe.php" method="get">
            ...
            <?php echo listasimplecompleta($paises, 'pais1'); ?> 
            <br/>
            <h2>Lista simple de países CON valor seleccionado</h2>
            <?php echo listasimplecompleta($paises, 'pais2', 'fr'); ?>
            
            <br/>
            <h2>Radio Button de países SIN valor seleccionado</h2>
            <?php echo radiobutton($paises, 'pais3'); ?> 
            <br/>
            <h2>Radio Button de países CON valor seleccionado</h2>
            <?php echo radiobutton($paises, 'pais4', 'pt'); ?>

            <br/><br/><input type="submit" name="boton" value="Enviar datos" />
