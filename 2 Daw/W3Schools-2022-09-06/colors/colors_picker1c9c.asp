...
<!-- Mirrored from www.w3schools.com/colors/colors_picker.asp?colorhex=5A3E36 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Jun 2021 00:17:41 GMT -->
<head>
...
<!-- begin cmp -->
<script src="http://cdn.snigelweb.com/sncmp/latest/sncmp_stub.min.js"></script>
<style>
...
<script type="text/javascript">
__cmp("setLogo", "../images/w3schools_logo_500_04AA6D.png");
__cmp("setPrivacyPolicy", "../about/about_privacy.html");
</script>
<script async type="text/javascript" src="http://cdn.snigelweb.com/pub/w3schools.com/snhb-loader.min.js"></script>
<!-- end cmp -->
<script>
...
<div id='myAccordion' class="w3-card-2 w3-center w3-hide-large w3-hide-medium" style="width:100%;position:absolute;display:none;background-color:#E7E9EB">
  ...
  <div class="w3-container w3-padding-32">
    ...
    <a class="w3-button w3-block" style="font-size:22px;" href="https://courses.w3schools.com/">Paid Courses</a>
...
-->
<div class="w3-col l3 m3 s12">
<a class="w3-button ws-grey w3-block w3-round" href="http://w3schools.invisionzone.com/" target="_blank" style="text-decoration:none;margin-top:1px;margin-bottom:1px">FORUM</a>
</div>
<div class="w3-col l3 m3 s12">
<a class="w3-button ws-grey w3-block w3-round" href="../about/default.html" target="_top" style="text-decoration:none;margin-top:1px;margin-bottom:1px">ABOUT</a>
</div>
<div class="w3-col l3 m3 s12">
...
<a href="colors_names.html">HTML Colors</a><br>
